...
仓库根目录下三篇 Markdown 文档总结了 long-running agent 的关键设计原则：

- [effective-harnesses-for-long-running-agents.md](effective-harnesses-for-long-running-agents.md) —— 长时运行 harness 的有效模式
- [harness-design-long-running-apps.md](harness-design-long-running-apps.md) —— 面向长时运行应用的 harness 设计
- [autonomous-coding-quickstart.md](autonomous-coding-quickstart.md) —— 自主编码 quickstart
